...
import { AVATARS, EXP, SOCIAL_XP_PER_LEVEL, TITLES_DATABASE, RARITIES, STAT_LABELS, RARITY_CONFIG, ROULETTE_SECTORS, ACHIEVEMENTS_DB, LEVEL_THRESHOLDS } from './constants.js';
import { getLevel } from './game.js';

// ========================================
//  КЭШИРОВАНИЕ DOM-ЭЛЕМЕНТОВ
// ========================================
// (Этот объект будет заполнен в Шаге 2)
export const dom = {};
...
// ========================================
//  НАВИГАЦИЯ И ОТОБРАЖЕНИЕ ЭКРАНОВ
// ========================================
...
export function renderQuests() {
    ...
    if (!currentUserData?.current_quests?.length) {
        container.innerHTML = `<div class="empty-state">Нет активных квестов. Зайдите завтра!</div>`;
        return;
    }
